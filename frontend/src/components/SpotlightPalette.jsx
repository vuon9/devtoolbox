...
const COMMANDS = [
  ...
  { id: 'formatter-json', label: 'Format JSON', path: '/tool/code-formatter?format=json', category: 'Formatter' },
  { id: 'formatter-xml', label: 'Format XML', path: '/tool/code-formatter?format=xml', category: 'Formatter' },
  { id: 'formatter-html', label: 'Format HTML', path: '/tool/code-formatter?format=html', category: 'Formatter' },
  { id: 'formatter-sql', label: 'Format SQL', path: '/tool/code-formatter?format=sql', category: 'Formatter' },
  { id: 'formatter-js', label: 'Format JavaScript', path: '/tool/code-formatter?format=javascript', category: 'Formatter' },

  // Text Converter - Encoding
  { id: 'converter-base64', label: 'Base64 Encode/Decode', path: '/tool/text-converter?category=Encode%20-%20Decode&method=Base64', category: 'Converter' },
  { id: 'converter-url', label: 'URL Encode/Decode', path: '/tool/text-converter?category=Encode%20-%20Decode&method=URL', category: 'Converter' },
  { id: 'converter-hex', label: 'Hex Encode/Decode', path: '/tool/text-converter?category=Encode%20-%20Decode&method=Base16%20(Hex)', category: 'Converter' },

  // Text Converter - Hashing
  { id: 'converter-md5', label: 'MD5 Hash', path: '/tool/text-converter?category=Hash&method=MD5', category: 'Hash' },
  { id: 'converter-sha256', label: 'SHA-256 Hash', path: '/tool/text-converter?category=Hash&method=SHA-256', category: 'Hash' },
  { id: 'converter-all-hashes', label: 'All Hashes', path: '/tool/text-converter?category=Hash&method=All', category: 'Hash' },

  // Text Converter - Conversions
  { id: 'converter-json-yaml', label: 'JSON ↔ YAML', path: '/tool/text-converter?category=Convert&method=JSON%20%E2%86%94%20YAML', category: 'Convert' },
  { id: 'converter-json-xml', label: 'JSON ↔ XML', path: '/tool/text-converter?category=Convert&method=JSON%20%E2%86%94%20XML', category: 'Convert' },
  { id: 'converter-markdown-html', label: 'Markdown ↔ HTML', path: '/tool/text-converter?category=Convert&method=Markdown%20%E2%86%94%20HTML', category: 'Convert' },
  ...
  // Data Generator
  { id: 'data-user', label: 'Generate User Data', path: '/tool/data-generator?preset=User', category: 'Generator' },
  { id: 'data-address', label: 'Generate Address Data', path: '/tool/data-generator?preset=Address', category: 'Generator' },
