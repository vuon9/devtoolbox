  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '8px 12px', borderRadius: '6px', border: '1px solid #27272a', backgroundColor: '#1c1917' }}>
      <input
        value={label}
        readOnly
        style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '13px', background: 'transparent', border: 'none', color: '#f4f4f5', width: '100px' }}
      />
      <span style={{ flex: 1, fontSize: '12px', color: '#71717a', fontStyle: 'italic' }}>{type}</span>
      <button
        onClick={onRemove}
