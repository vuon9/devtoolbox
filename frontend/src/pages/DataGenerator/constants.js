...
export const HELP_CONTENT = {
  syntax: {
    ...
    examples: [
      ...
      {
        syntax: '{{range $i, $_ := iterate .BatchCount}}...{{end}}',
        desc: 'Batch generation loop',
      },
    ],
  },
  functions: [
    ...
    {
      category: 'Person',
      items: 'FirstName, LastName, Name, Gender, Email, Phone, PhoneFormatted',
    },
    { category: 'Internet', items: 'Username, URL, Domain, IP, IPv6, Mac, Password' },
    {
      category: 'Address',
      items: 'Street, City, State, StateAbr, Zip, Country, CountryAbr, Latitude, Longitude',
    },
    ...
    { category: 'Credit Card', items: 'CardType, CardNumber, CVV, Expiry' },
    {
      category: 'Other',
      items:
        'Bool, StringCustom length upper lower nums sym, Price min max, RandomString opt1 opt2',
    },
