...
import { TOOL_TITLE, TOOL_DESCRIPTION, STORAGE_KEYS, DEFAULTS } from './strings';
...
export default function StringUtilities() {
  ...
  const renderPane = () => {
    switch (activeTab) {
      case 0:
        return <SortDedupePane input={input} setInput={setInput} layout={layout} />;
      case 1:
        return <CaseConverterPane input={input} setInput={setInput} layout={layout} />;
      case 2:
        return <InspectorPane input={input} setInput={setInput} layout={layout} />;
      default:
        return null;
    }
  };
